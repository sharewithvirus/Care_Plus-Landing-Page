      ...
      >
          ...
          <div className="col-md-7 text-center ">
            <div className="row">
              <div className="col-md-7  px-5">
                <h1 className="my-4" style={{ fontSize: "2.5rem" }}>
                  Contact Us
                </h1>
        ...
        <div className="row d-flex justify-content-center mb-4 ">
          <div className="col-md-5 text-center text-white ">
            <h6>
              <Link to="/privacy-policy" style={{ cursor: "pointer" }}>
                <strong>PRIVACY POLICY</strong>
              </Link>{" "}
              -
              <Link to="/terms-condition" style={{ cursor: "pointer" }}>
                <strong>TERMS OF USE</strong>
              </Link>{" "}
              -
              <Link to="/return&refund" style={{ cursor: "pointer" }}>
                <strong>Return And Refund Policy</strong>
              </Link>
              -<span>COOKIES POLICY © 2022 CarePlus | ALL RIGHTS RESERVED</span>
            </h6>
          </div>
        </div>
      </div>
